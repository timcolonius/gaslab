...
from gaslab.plotting import STATE_COLORS, mollier_figure, pressure_deflection_figure, theta_beta_m_figure
...
class GasLabApp:
    ...
    def _update_latest_areachg(self, *_events) -> None:
        self._update_latest_operation(
            "areachg",
            {"ar": self.area_ratio_input.value, "throat": self.throat_input.value},
        )

    def _update_latest_fanno(self, *_events) -> None:
        self._update_latest_operation("fanno", {"fric": self.fanno_input.value})

    def _update_latest_rayleigh(self, *_events) -> None:
        self._update_latest_operation("rayleigh", {"t0ratio": self.rayleigh_input.value})
    ...
    def _apply_fanno(self, _event) -> None:
        ...
        self._apply_operation("fanno", {"fric": self.fanno_input.value})
    ...
    def _apply_rayleigh(self, _event) -> None:
        ...
        self._apply_operation("rayleigh", {"t0ratio": self.rayleigh_input.value})
    ...
    def view(self):
        ...
        left = pn.Column(self.banner, gas_panel, initial_state_panel, process_panel, options_panel, width=360)
...
app = GasLabApp()
app.view().servable(title="Gaslab Prototype")
